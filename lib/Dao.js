...
Dao.prototype.query = function(hostUrl, db, collectionName, query, fields, options, cb) {
    var T = this,
        dbName = db;
    // console.log(db, collectionName, query, fields, options);

    ConnectionPool.getHostByHostAndPortStringAndDatabase(hostUrl, db, function(err, db) {
        if (!err) {
...
Dao.prototype.queryAsCursor = function(hostUrl, db, collectionName, query, fields, options, cb) {
    var T = this,
        dbName = db;
...
Dao.prototype.collections = function(hostUrl, dbName, fields, options, cb) {
    var T = this;
    ConnectionPool.getHostByHostAndPortStringAndDatabase(hostUrl, dbName, function(err, db) {
...
Dao.prototype.get = function(hostUrl, dbName, collectionName, query, fields, options, cb) {
    var T = this
    ConnectionPool.getHostByHostAndPortStringAndDatabase(hostUrl, dbName, function(err, db) {
        if (!err) {
            db.collection(collectionName, function(err, collection) {
...
Dao.prototype.distinct = function(hostUrl, dbName, collectionName, query, field, options, cb) {
    var T = this;
...
Dao.prototype.save = function(hostUrl, dbName, collectionName, body, cb) {
    var T = this
    ConnectionPool.getHostByHostAndPortStringAndDatabase(hostUrl, dbName, function(err, db) {
        if (!err) {
            db.collection(collectionName, function(err, collection) {
...
Dao.prototype.update = function(hostUrl, dbName, collectionName, query, newObj, options, cb) {
    var T = this
...
Dao.prototype.count = function(hostUrl, dbName, collectionName, query, options, cb) {

    var T = this

    ConnectionPool.getDb(hostUrl, dbName, function(err, db) {
        if (!err) {
            db.collection(collectionName, function(err, collection) {
...
Dao.prototype.remove = function(hostUrl, dbName, collectionName, query, options, cb) {
    var T = this
