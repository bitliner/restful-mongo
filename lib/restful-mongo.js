...
RestfulMongo.prototype._setGetForCount = function _setGetForCount(app) {
	app.get('/api/:host/:db/:collection/count', HttpGet.count.bind(this));
};
RestfulMongo.prototype._setGetForDistinct = function _setGetForDistinct(app) {
	app.get('/api/:host/:db/:collection/distinct/:key', HttpGet.distinct.bind(this));
};
RestfulMongo.prototype._setGet = function _setGet(app) {
	app.get('/api/:host/:db/collections', HttpGet.collections.bind(this));
	app.get('/api/:host/:db/:collection/:id?', HttpGet.query.bind(this));
};
RestfulMongo.prototype._setDel = function _setDel(app) {
	app.del('/api/:host/:db/:collection/:id', HttpDelete.remove.bind(this));
};
RestfulMongo.prototype._setPut = function _setPut(app) {
	app.put('/api/:host/:db/:collection/:id', HttpPut.update.bind(this));
};
RestfulMongo.prototype._setPost = function _setPost(app) {
	app.post('/api/:host/:db/:collection', HttpPost.insert.bind(this));
	app.post('/api/:host/:db/:collection/query', HttpPost.query.bind(this));
};
