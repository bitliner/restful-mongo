...
function HandlerHttpGet = function (dao) {
    this.dao = dao;
}

HandlerHttpGet.prototype.count = function(req, res) {
    var query = {},
    fields = {},
    options = {};
...
HandlerHttpGet.prototype.distinct = function(req, res) {
    var query = {},
    options = {},
    key;
...
HandlerHttpGet.prototype.get = function(req, res) {
